...
// ----------------------------------------------------------------------
// Base Components (Root, Portal, Trigger, Group, etc.)
// ----------------------------------------------------------------------
...
export interface DropdownMenuContentProps
  ...
  /** Add a decorative gold ribbon at the top of the menu */
  decorative?: boolean;
}
...
function DropdownMenuSubTrigger({
  ...
  return (
    ...
    >
      {children}
      <ChevronRightIcon className="ml-auto size-4 text-gold/60" />
    </DropdownMenuPrimitive.SubTrigger>
  );
}
